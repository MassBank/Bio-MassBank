...
<head>
	...
	<title>Bio-MassBank | Menu Link</title>
</head>
<body>
<%
	...
	out.println("\t\t\t<img src=\"../image/massbank-icon-purple.gif\" align=\"absmiddle\" hspace=\"0\">");
	out.println("\t\t\t<a href=\"http://bio.massbank.jp/\" target=\"_blank\">Bio-MassBank</a>");
	out.println("\t\t</td>");
	out.println("\t</tr>");
